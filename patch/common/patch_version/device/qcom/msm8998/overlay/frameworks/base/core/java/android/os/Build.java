...
public class Build {
	...
	// Flex :: Fixed version mechanism ++++++++++
	/** A SW version string meant for displaying to the user 
	* @hide
	*/
	public static final String SW_VERSION = getString("ro.build.display.software.id");
	
	/** A HW version string meant for displaying to the user 
	* @hide
	*/
	public static final String HW_VERSION = getString("ro.build.display.hardware.id");
	// Flex :: Fixed version mechanism ----------
