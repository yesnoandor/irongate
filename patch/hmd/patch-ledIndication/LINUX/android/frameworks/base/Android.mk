...
base_file_overlay_prefix := $(addprefix ../../device/qcom/msm8998/overlay/, $(LOCAL_PATH)/)
base_file_overlay_subdir := $(addprefix $(base_file_overlay_prefix), $(FRAMEWORKS_BASE_SUBDIRS))
$(warning $(base_file_overlay_subdir))
overlay_java_file = $(call find-other-java-files,$(base_file_overlay_subdir))
$(warning $(overlay_java_file))
...
LOCAL_SRC_FILES += \
	...
	core/java/android/os/IFlexService.aidl \
